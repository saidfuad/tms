...
if (isset($_POST['cancel'])) {
	print "<script>location.href = 'mess_led.php'</script>";
}
	...
	if(!$result ){
		die("<SCRIPT LANGUAGE='JavaScript'>alert('Unknown Error Occured!')</script><script>location.href = 'mess_led.php'</script>");
	}
	...
	print("<form name='ok_form' method='post' action='mess_led.php'>");
	...
	print("<form name = 'reply_form' method = 'post' action = 'com_mes_led.php'>");
