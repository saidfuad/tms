...
while ($db_field = mysql_fetch_assoc($result)) {
	...
	print("<tr>");
	if($a == 0){
		print("<td align = 'center' width = '1'><a href = 'read_mail_led.php?key=".$ctrl."'><img src = 'images/unopened.jpg' border = '0'></img></a></td>");
	}
	else{
		print("<tr><td align = 'center' width = '1'><a href = 'read_mail_led.php?key=".$ctrl."'><img src = 'images/opened.jpg' border = '0'></img></a></td>");
	}
	...
	print("<td align = 'center' width ='75'><a href = 'reply_mail_led.php?key=".$b."'><img src = 'images/reply.jpg' border = '0'></img></a>");
	print("<a href = 'delete_mail_led.php?key=".$ctrl."'><img src = 'images/deletemail.jpg' border = '0'></img></a></td>");
	print("</tr>");
}
?>
...
<a href = "com_mes_led.php"><img src = "images/compose.gif" border = "0"></img></a>
</div>

<div style="top:100; left:10; position:absolute; z-index:1;">
<a href = "inboxl.php"><img src = "images/inbox.gif" border = "0"></img></a>
</div>

<div style="top:150; left:10; position:absolute; z-index:1;">
<a href = "sent_itemsl.php"><img src = "images/sentitems.gif" border = "0"></img></a>
</div>
