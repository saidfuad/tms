...
while ($db_field = mysql_fetch_assoc($result)) {
	...
	print("<tr>");
	if($a == 0){
		print("<td align = 'center' width = '1'><a href = 'read_mail_sl.php?key=".$ctrl."'><img src = 'images/unopened.jpg' border = '0'></img></a></td>");
	}
	else{
		print("<tr><td align = 'center' width = '1'><a href = 'read_mail_sl.php?key=".$ctrl."'><img src = 'images/opened.jpg' border = '0'></img></a></td>");
	}
	...
	print("<a href = 'delete_mail_sl.php?key=".$ctrl."'><img src = 'images/deletemail.jpg' border = '0'></img></a></td>");
	print("</tr>");
}
?>
