...
if (isset($_POST['cancel'])) {
	print "<script>location.href = 'inboxm.php'</script>";
}
	...
	if(!$result ){
		die("<SCRIPT LANGUAGE='JavaScript'>alert('Unknown Error Occured!')</script><script>location.href = 'mess_mem.php'</script>");
	}
	$msg = "Message Sent.";
	print("<div style='top:260; left:550; position:absolute; z-index:1;'>");
	print("<form name='ok_form' method='post' action='mess_mem.php'>");
	...
	print("<b><font face='Arial' size = '3'>$name</font></b>");
	print("</div>");
	...
	print("<form name = 'reply_form' method = 'post' action = 'reply_mail_mem.php'>");
	print("<input name = 'hid_nem' type = 'hidden' value = $name>");
